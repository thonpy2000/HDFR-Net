...
def default_train(train_loader, model, optimizer, writer, iter_counter, args):
    ...
    for i, (inp, _) in enumerate(train_loader):
        ...
        loss_total = ((1-lamda)*loss_h + lamda*loss_d)*2
        ...
        log_prediction = (1-lamda)*log_prediction_h + lamda*log_prediction_d
    ...
    writer.add_scalar('HDFR_loss', avg_loss, iter_counter)
