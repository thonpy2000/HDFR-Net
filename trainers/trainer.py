...
def train_parser():
    ...
    parser.add_argument("--epoch", help="number of epochs before lr is cut by gamma", type=int, default=130)
    ...
    parser.add_argument("--train_query_shot", help="number of query images per class during meta-training", type=int, default=15) # 15
    ...
    parser.add_argument("--dataset", choices=['stanford_dog', 'stanford_car', 'cub_raw', 'aircraft'])

    parser.add_argument("--model", choices=['HDFR_Net'], default='HDFR_Net')
